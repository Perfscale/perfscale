...
## Corpus Check
- 61 files · ~71,364 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1336 nodes · 2367 edges · 81 communities (69 shown, 12 thin omitted)
...
Cohesion: 0.08
Nodes (54): Arc, BTreeMap, Arc, Context, Default, HttpSample, LogLine, LogTag (+46 more)
...
Cohesion: 0.17
Nodes (27): Context, HttpSample, LogTag, Option, Result, String, Value, Vec (+19 more)
...
Cohesion: 0.29
Nodes (8): Client, Map, HeaderMap, header_map_to_json(), http_action(), HttpSample, shared_client(), shared_insecure_client()
...
Cohesion: 0.09
Nodes (60): ActionOutput, ClientConfig, Error, Context, Gen, Instant, Option, Result (+52 more)
...
## Knowledge Gaps
- **380 isolated node(s):** `PreToolUse`, `Commands`, `Commands`, `SchemaDumpKind`, `SchemaDumpKind` (+375 more)
...
- **Why does `execute_action()` connect `Step Actions (http/check/log/sleep)` to `Community 65`, `Community 66`, `Community 70`, `Step Runner Core`, `Community 76`, `Community 79`, `Community 80`, `Schema Generation`, `Community 63`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `Json` connect `Serve HTTP Endpoints` to `Step Actions (http/check/log/sleep)`, `Step Runner Core`, `Community 74`, `Context Interpolation`, `VUs Schema Property`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Are the 19 inferred relationships involving `execute_action()` (e.g. with `lint::lint` and `run_before()`) actually correct?**
  _`execute_action()` has 19 INFERRED edges - model-reasoned connections that need verification._
