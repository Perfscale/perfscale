# Graph Report - perfscale  (2026-07-08)

## Corpus Check
- 49 files · ~40,523 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 929 nodes · 1547 edges · 62 communities (51 shown, 11 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `afe6aef6`
...
Cohesion: 0.08
Nodes (51): Client, Context, Error, HttpSample, LogTag, Option, String, Value (+43 more)
...
Cohesion: 0.11
Nodes (30): Arc, k6-compatible summary format, Context, HttpSample, LogLine, LogTag, RunConfig, Self (+22 more)
